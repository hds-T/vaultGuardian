...
const STRINGS = {
  en: {
    ...
    'intro.copy': 'Convince the Guardian. Steal each password. Open the Vault.',
    'intro.rules': '10 messages per door. A spent message is spent.',
    'intro.footer': 'Offline via QVAC. The password never leaves the server.',
    'intro.pick': 'Choose your language',
    'header.tagline': 'Convince the Guardian to hand over the word.',
    'pill.model': 'local model',
    'pill.admin': 'admin →',
    'pill.restart': 'restart',
    'pill.restartTitle': 'Abandon this run and return to the start',
    ...
    'close.title': 'You have won.',
    'close.copy': 'Every word is yours. You have earned the right to open the Vault.',
    'close.open': 'Open the Vault',
  ...
  es: {
    ...
    'intro.copy': 'Convence al Guardián. Róbale cada contraseña. Abre la Cámara.',
    'intro.rules': '10 mensajes por puerta. Un mensaje gastado está gastado.',
    'intro.footer': 'Sin conexión con QVAC. La contraseña nunca sale del servidor.',
    'intro.pick': 'Elige tu idioma',
    'header.tagline': 'Convence al Guardián de que suelte la palabra.',
    'pill.model': 'modelo local',
    'pill.admin': 'admin →',
    'pill.restart': 'reiniciar',
    'pill.restartTitle': 'Abandonar esta partida y volver al inicio',
    ...
    'close.title': 'Has ganado.',
    'close.copy': 'Todas las palabras son tuyas. Te has ganado el derecho a abrir la Cámara.',
    'close.open': 'Abre la Cámara',
  ...
  ca: {
    ...
    'intro.copy': 'Convenç el Guardià. Roba-li cada contrasenya. Obre la Cambra.',
    'intro.rules': '10 missatges per porta. Un missatge gastat és gastat.',
    'intro.footer': 'Fora de línia amb QVAC. La contrasenya no surt mai del servidor.',
    'intro.pick': 'Tria la teva llengua',
    'header.tagline': 'Convenç el Guardià perquè amolli la paraula.',
    'pill.model': 'model local',
    'pill.admin': 'admin →',
    'pill.restart': 'reinicia',
    'pill.restartTitle': 'Abandona aquesta partida i torna al principi',
    ...
    'close.title': 'Has guanyat.',
    'close.copy': "Totes les paraules són teves. T'has guanyat el dret d'obrir la Cambra.",
    'close.open': 'Obre la Cambra',
